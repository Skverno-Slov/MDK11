...
namespace Lection1024.Controllers
{
    ...
    public class GamesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Game>>> GetGameByCategories(string categories)
        {
        ...
        [HttpGet("category")] // category=category M:M (games-category)
        public async Task<ActionResult<IEnumerable<Game>>> GetGameByCategory(string name)
        {
        ...
        public async Task<ActionResult<IEnumerable<Game>>> GetGameByPrice(string price)
        {
            ...
            if (!Int32.TryParse(values[0], out minPrice) ||
                !Int32.TryParse(values[1], out maxPrice))
                return BadRequest();
        ...
        public async Task<ActionResult<IEnumerable<Game>>> GetGameByFilters(string filters)
        {
